...
# Display
TARGET_SCREEN_DENSITY := 563 #Screen DPI/PPI
...
TARGET_USERIMAGES_USE_F2FS := true #False for ext4
...
# Recovery
#BOARD_HAS_LARGE_FILESYSTEM := true
#TARGET_RECOVERY_FSTAB := $(DEVICE_PATH)/recovery/root/system/etc/fstab.alphalm
